...
const ModalItem = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoadding(true);
      const res = await requestGET(`api/v1/labormarketinformations/${id}`);
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id
        ? await requestPUT(`api/v1/labormarketinformations/${id}`, formData)
        : await requestPOST(`api/v1/labormarketinformations`, formData);
      if (res) {
            ...
            <Form form={form} layout='vertical' /* initialValues={initData} */ autoComplete='off'>
              <div className='row'>
                ...
                <div className='col-xl-4 col-lg-6'>
                  <FormItem label='Ngày ban hành' name='date'>
