...
import {toAbsoluteUrl as toAbsoluteUrlMetronic} from 'src/_metronic/helpers';
        ...
        <div className='menu-content d-flex align-items-center px-3'>
          ...
          <div className='d-flex flex-column'>
            <div className='fw-bolder d-flex align-items-center fs-5'>
              {user.fullName}
              <span className='badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2'>Đã xác thực</span>
            </div>
